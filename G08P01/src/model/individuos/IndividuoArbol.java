...
public class IndividuoArbol extends Individuo<String>{
	...
	public static final String[] operadores = new String[] {"add", "mul", "sub"};
	
	public static final String[] terminales = new String[] {"x", "1", "2", "0", "-1", "-2"};
